...
m_c <- motifs(active_user_g)
plot(graph_from_isomorphism_class(3, 0))
plot(graph_from_isomorphism_class(3, 1))
plot(graph_from_isomorphism_class(3, 2))
plot(graph_from_isomorphism_class(3, 3))
plot(graph_from_isomorphism_class(3, 4))
plot(graph_from_isomorphism_class(3, 5))
plot(graph_from_isomorphism_class(3, 6))
plot(graph_from_isomorphism_class(3, 7))
plot(graph_from_isomorphism_class(3, 8))
plot(graph_from_isomorphism_class(3, 9))
plot(graph_from_isomorphism_class(3, 10))
plot(graph_from_isomorphism_class(3, 11))
plot(graph_from_isomorphism_class(3, 12))
plot(graph_from_isomorphism_class(3, 13))
plot(graph_from_isomorphism_class(3, 14))
plot(graph_from_isomorphism_class(3, 15))
